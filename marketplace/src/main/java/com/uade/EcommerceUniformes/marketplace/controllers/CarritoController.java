...
public class CarritoController {
    ...
    public Optional<Carrito> getCarritoByUsuarioId(@AuthenticationPrincipal Usuario usuario) {
        return carritoService.getCarritoByUsuarioId(usuario.getId());
    }

    // POST http://localhost:4002/carritos/usuario/1
    @PostMapping("/crear")
    public ResponseEntity<Object> createCarrito(@AuthenticationPrincipal Usuario usuario) {
        Carrito resultado = carritoService.createCarrito(usuario.getId());
...
// POST http://localhost:4002/carritos/1/confirmar
